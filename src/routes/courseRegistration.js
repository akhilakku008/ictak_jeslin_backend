...
app.post('/courseRegister', async function (req, res) {
    ...
    console.log("coursereg   mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm"+req);
    ...
    await RegisterCourse.findOne({ 'email': RegistrationItem.email, 'courseId': RegistrationItem.courseId })
